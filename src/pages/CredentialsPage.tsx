...
import { Database, Eye, EyeOff, GitBranch, Settings, Globe, Cloud, AlertTriangle, MessageSquare, Copy, CheckCircle, Loader, RefreshCw, ShieldCheck, CheckCircle2, XCircle, AlertCircle, ArrowRight, Zap, Hammer } from 'lucide-react';
                    ...
                    <div style={{
                      ...
                      <div>
                        <div style={{ fontSize: '0.88rem', fontWeight: 800, color: '#c084fc', display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <Hammer size={15} /> EvaForge Engine License Concurrency Quotas
