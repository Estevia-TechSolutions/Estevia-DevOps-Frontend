                ...
                <div className="glass-panel" style={{ padding: '24px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%', boxSizing: 'border-box' }}>
                    ...
                    <form onSubmit={handleUpdateLicensing} style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '20px' }}>
                        {[
                          { id: 'growth', name: 'Growth Plan', price: '$1,000 / ₹83,000', color: '#3b82f6', bg: 'rgba(59,130,246,0.08)', border: 'rgba(59,130,246,0.25)', glow: 'rgba(59,130,246,0.2)', features: ['10 Active Operators limit', '⚡ 3 Parallel EvaForge Concurrency Slots', 'Standard shared runners', 'Email support (business hours)', 'Base infra metrics tracking'] },
                          { id: 'enterprise', name: 'Enterprise', price: '$2,000 / ₹1,66,000', color: '#8b5cf6', bg: 'rgba(139,92,246,0.08)', border: 'rgba(139,92,246,0.25)', glow: 'rgba(139,92,246,0.2)', features: ['30 Active Operators limit', '⚡ 10 Parallel EvaForge Concurrency Slots', 'Dedicated build runners', '24/7 Priority support SLAs', 'Advanced insights dashboard', 'Custom Key Vault integration'] },
                          { id: 'sovereign', name: 'Sovereign', price: '$4,000 / ₹3,32,000', color: '#14b8a6', bg: 'rgba(20,184,166,0.08)', border: 'rgba(20,184,166,0.25)', glow: 'rgba(20,184,166,0.2)', features: ['Unlimited active operators', '⚡ 25 Parallel EvaForge Concurrency Slots', 'Self-hosted private nodes', 'Dedicated SLA guarantees', 'Audit logs & SSO authentication', 'Multi-tenant routing rules'] }
                        ].map(tier => {
